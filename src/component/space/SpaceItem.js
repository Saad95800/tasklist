...
import { setSpacesToDelete, setSpaceToEdit, setViewFormEditSpace, setContextSpace, deleteSpace, setIdSpaceConfirmDelete } from '../../redux/space/SpaceSlice'
        ...
        <React.Fragment>
          <CardContent className="position-relative">
            ...
            <CloseIcon onClick={()=>{
              ...
              store.dispatch(setIdSpaceConfirmDelete(space.id))
            }}/>
