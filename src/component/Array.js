...
// étape 2 - Je créer un (ou des) composant(s) pour les élément dynamiques
    return (
        ...
        onDrop={(e)=>{
            ...
            if(e.dataTransfer.getData('id_task') !== undefined && e.dataTransfer.getData('id_task') !== null){
                moveTask(id_task, id_array_drop)
            }
            if(e.dataTransfer.getData('id_array_drag') !== undefined && e.dataTransfer.getData('id_array_drag') !== null){
